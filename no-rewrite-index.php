...
if ($page != 1) {echo '<a href="http://'.$sitehost.'/index.php?page=1" ><strong>首页</strong></a><a href="http://'.$sitehost.'/index.php?page='.($page - 1).'" class="pagelist"><strong>上一页</strong></a>';}
for ($i=1;$i<=$totalPage;$i++) if($page < $limit_page && $i < $limit_page){echo '<a href="http://'.$sitehost.'/index.php?page='.$i.'" class="pagelist">'.$i.'</a>';}
if ($page<$totalPage) {echo '<a href="http://'.$sitehost.'/index.php?page='.($page + 1).'" class="pagelist">下一页</a><a href="http://'.$sitehost.'/index.php?page='.$totalPage.'" class="pagelist">尾页</a>';}
...
for ($i=1;$i<=$totalPage;$i++) echo '<option value="http://'.$sitehost.'/index.php?page='.$i.'">'.$i.'</option>';
